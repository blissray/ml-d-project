...
def main(_):
    ...
    if os.path.exists(os.path.join(TRAIN_PATH, "tfrecords")) is not True:
        os.mkdir(os.path.join(TRAIN_PATH, "tfrecords"))
        os.mkdir(os.path.join(VAL_PATH, "tfrecords"))

    for output_path in [TRAIN_PATH, VAL_PATH]:
        tf_records_path = os.path.join(output_path, "tfrecords")
        image_path = os.path.join(output_path, "image")
        csv_path = os.path.join(output_path, "annotation", "labels.csv")
