...
DATA_URL = "https://storage.googleapis.com/teamlab-data/simple_segmentation.zip"
DATA_DIR = "data"
MODEL_DIR = "models"
...
def _data_downlad(dataset_name):
  download_path = os.path.join(DATA_DIR, "simple_segmentation.zip")
...
def main(args):
  ...
  data_path = os.path.join(DATA_DIR, "simple_segmentation.zip") 
